...
public class configframe extends JFrame {
	...
	public configframe() {
		...
		btnAddMachine.setBackground(new Color(0, 0, 128));
		btnAddMachine.setFocusable(false);
		btnAddMachine.setForeground(new Color(255, 255, 255));
		...
		btnAddAdjuster.setBackground(new Color(0, 0, 128));
		btnAddAdjuster.setForeground(new Color(255, 255, 255));
		btnAddAdjuster.setFocusable(false);
