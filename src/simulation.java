...
public class simulation extends JFrame {
	...
	/*	btnBack.addActionListener(new ActionListener() {
		...
		btnAdjusterUtilisation.setFocusable(false);
		btnAdjusterUtilisation.setBackground(new Color(0, 0, 128));
		btnAdjusterUtilisation.setForeground(new Color(255, 255, 255));
		...
		btnMachinewiseUtilisation.setFocusable(false);
		btnMachinewiseUtilisation.setForeground(new Color(255, 255, 255));
		btnMachinewiseUtilisation.setBackground(new Color(0, 0, 128));
